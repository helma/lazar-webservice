...
# Get the source code for lazar-core

	@git clone git@github.com:helma/lazar-core.git lib/lazar-core@

# Get the correct branch for lazar-core
...
# Create an user for model creation

	@script/console@
	@>> User.create(:name => 'my_username', :hashed_password => Digest::MD5.hexdigest('my_secret_password'))@
	@exit@
